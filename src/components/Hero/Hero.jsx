...
const Hero = () => {
  return (
    <div className=" w-[100%] h-[100vh] md:h-[97vh]  bg-[#000]  rounded-[40px]">
      <div className="flex flex-col bg-[#000] gap-[150px]">
        ...
        <div
          className="flex  justify-center w-[100%] items-center mt-[-260px]"
          id="timeline-section"
        >
          <EventCard />
        </div>
        <div
          className="flex  justify-center w-[100%] items-center mt-[-150px]"
          id="prizes-section"
        >
          <Prizes />
        </div>
